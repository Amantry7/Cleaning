...
JAZZMIN_SETTINGS = {
    "site_title": "Osh Cleaning",  # Заголовок админ-панели
    "site_header": "Osh Cleaning",  # Заголовок на экране входа
    "site_brand": "Osh Cleaning",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в Osh Cleaning",  # Приветственное сообщение
    "site_title": "Osh Cleaning",  # Заголовок админ-панели
    "site_header": "Osh Cleaning",  # Заголовок на экране входа
    "site_brand": "Osh Cleaning",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в Osh Cleaning",  # Приветственное сообщение
